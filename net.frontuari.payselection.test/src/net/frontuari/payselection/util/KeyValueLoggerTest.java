...
package net.frontuari.payselection.util;

import static net.frontuari.payselection.test.util.RandomTestUtil.*;
import static net.frontuari.payselection.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"net.frontuari.payselection.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"net.frontuari.payselection.util\"");
	}
