...
- New callout
    ...
    * Example: net.frontuari.payselection.callout.CStringFormat

- New process
    * Name: PName
    * Package: net.frontuari.payselection.process
    * Example: net.frontuari.payselection.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: net.frontuari.payselection.form
    * Example: net.frontuari.payselection.form.FMultiPayment

- New event
    * Name: EName
    * Package: net.frontuari.payselection.event
    * Example: net.frontuari.payselection.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: net.frontuari.payselection.model
    * Example: net.frontuari.payselection.model.MTableExample
...
- New callout
    * Create callout in package `net.frontuari.payselection.callout`, extends from `CustomCallout`
    * Register callout in `net.frontuari.payselection.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `net.frontuari.payselection.process`, extends from `CustomProcess`
    * Register process in `net.frontuari.payselection.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `net.frontuari.payselection.form`, extends from `CustomForm`
    * Register form in `net.frontuari.payselection.component.FormFactory`. Example:
...
- New event
    * Create event in package `net.frontuari.payselection.event`, extends from `CustomEvent`
    * Register event in `net.frontuari.payselection.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `net.frontuari.payselection.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `net.frontuari.payselection.component.ModelFactory`. Example:
