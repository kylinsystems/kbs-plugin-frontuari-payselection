 ...
 *    Jorge Colmenarez - Frontuari, C.A. - Call confirmPaySelectionCheck
*/
public class WFTUPayRePrint extends FTUPayPrint implements ValueChangeListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = -679427308759715022L;
	...
	{
		//  C_PaySelection_ID
		int AD_Column_ID = 5609;        //  C_PaySelection.C_PaySelection_ID
	...
	protected void cmd_print()
	{
		...
		{
			FTUMPaySelectionCheck check = m_checks[i];
