 ...
 */
public class FTUMAllocationLine extends MAllocationLine
{
	/**
	 * 
	 */
	 ...
	 *	@param trxName name
	 */
	public FTUMAllocationLine (Properties ctx, int C_AllocationLine_ID, String trxName)
	{
	 ...
	 */
	public FTUMAllocationLine (Properties ctx, ResultSet rs, String trxName)
	{
	 ...
	 *	@param parent parent
	 */
	public FTUMAllocationLine (FTUMAllocationHdr parent)
	{
	 ...
	 */
	public FTUMAllocationLine (FTUMAllocationHdr parent, BigDecimal Amount, 
	...
	private static CLogger	s_log	= CLogger.getCLogger (FTUMAllocationLine.class);
	/**	Invoice info			*/
	private MInvoice		m_invoice = null; 
	/** Allocation Header		*/
	private FTUMAllocationHdr	m_parent = null;
	
	/**
	 * 	Get Parent
	 *	@return parent
	 */
	public FTUMAllocationHdr getParent()
	{
		if (m_parent == null)
			m_parent = new FTUMAllocationHdr (getCtx(), getC_AllocationHdr_ID(), get_TrxName());
		return m_parent;
	}	//	getParent
	 ...
	 *	@param parent parent
	 */
	protected void setParent (FTUMAllocationHdr parent)
	{
		m_parent = parent;
	}	//	setParent
	...
	protected int processIt (boolean reverse)
	{
		...
		if (C_Payment_ID != 0)
		{
			FTUMPayment payment = new FTUMPayment (getCtx(), C_Payment_ID, get_TrxName());
