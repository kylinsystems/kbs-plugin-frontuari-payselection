...
call mvn validate -Didempiere.target=net.frontuari.payselection.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=net.frontuari.payselection.p2.targetplatform %DEBUG_MODE%
